...
namespace pruebaPagoMp.Migrations
{
    ...
    [Migration("20260225173124_Add_AdminGeneral_Bitacora_Caja_Promociones_Reportes")]
    partial class Add_AdminGeneral_Bitacora_Caja_Promociones_Reportes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Bitacora.BitacoraEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Caja.Caja", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Compras.Compra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Compras.DetalleCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Compras.FacturaProveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Compras.Proveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Promociones.Promocion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Compras.DetalleCompra", b =>
                {
                    b.HasOne("pruebaPagoMp.Models.Compras.Compra", "Compra")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("pruebaPagoMp.Models.Compras.FacturaProveedor", b =>
                {
                    b.HasOne("pruebaPagoMp.Models.Compras.Compra", "Compra")
                        .WithOne("FacturaProveedor")
                        .HasForeignKey("pruebaPagoMp.Models.Compras.FacturaProveedor", "CompraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
